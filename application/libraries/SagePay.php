...
class SagePay
{
    ...
    /*  -- GENERAL FUNCTIONS (not to be called externally) -- */
    ...
    public function _call($operation, $request)
    {
    ...
    /*  -- SERVICE-SPECIFIC FUNCTIONS (externally available) --  */
     ...
     */
    public function txPayment(array $customer, array $order)
    {
     ...
     */
    public function txAuthorize(array $order)
    {
     ...
     * @return  array   $result (Success, VPSProtocol, Status, StatusDetail)
     */
    public function txRelease(array $order)
    {
     ...
     *                  PostcodeResult, CV2Result)
     */
    public function txRepeat(array $order)
    {
     ...
     *                  VPSTxId, TxAuthNo)
     */
    public function txRefund(array $order)
    {
     ...
     *                  VPSTxId, TxAuthNo)
     */
    public function txDirectRefund(array $order, array $card)
    {
     ...
     */
    public function txManual(array $customer, array $card, array $order)
    {
     ...
     * @return  array   $result (Success, VPSProtocol, Status, StatusDetail)
     */
    public function txCancel(array $order)
    {
     ...
     * @return  array   $result (Success, VPSProtocol, Status, StatusDetail)
     */
    public function txAbort(array $order)
    {
     ...
     * @return  array   $result (Success, VPSProtocol, Status, StatusDetail)
     */
    public function txVoid(array $order)
    {
...
/* Location: application/libraries/SagePay.php */